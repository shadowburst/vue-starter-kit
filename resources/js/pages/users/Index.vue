...
const rowActions: DataTableRowAction<UserIndexResource>[] = [
    {
        ...
        label: trans('edit'),
        icon: PencilIcon,
        href: (user) => route('users.edit', { user }),
    },
    {
        type: 'callback',
        label: trans('trash'),
        ...
        callback: (user) =>
            alert({
                ...
                callback: () =>
                    router.delete<UserOneOrManyRequest>(route('users.trash', { user }), {
                        only: ['users'],
                    }),
            }),
    },
    {
        ...
        callback: (user) =>
            alert({
                ...
                callback: () =>
                    router.patch<UserOneOrManyRequest>(route('users.restore', { user }), undefined, {
                        only: ['users'],
                    }),
            }),
    },
    {
        ...
        callback: (user) =>
            alert({
                ...
                callback: () =>
                    router.delete<UserOneOrManyRequest>(route('users.delete', { user }), {
                        only: ['users'],
                    }),
            }),
    },
